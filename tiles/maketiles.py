...
if num_tiles>0:
    ...
    pads = (0,1,2,3,4,5,10,25,50,75,100,250,500,750,1000)
...
for c in img_classes:
    ...
    non_tile_imgs = [i for i in os.listdir(in_path) if not os.path.isdir(in_path+'/'+i)]
    class_examples = np.random.choice(non_tile_imgs, img_per_class, replace=True)
